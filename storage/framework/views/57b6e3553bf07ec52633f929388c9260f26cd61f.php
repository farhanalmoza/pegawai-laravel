...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-6 col-md-4 mx-auto bg-light p-4">
            <div class="card">
                <div class="card-header"><?php echo e(__('Login Aplikasi')); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pegawai\resources\views/auth/login.blade.php ENDPATH**/ ?>