	...
	<form method="post" action="{{ route('pegawai.update', $pegawai->id_pegawai) }}" enctype="multipart/form-data">
	  ...
	  <div class="form-group row">
	  	...
	  	<div class="col-sm-5">
			...
			<img src="{{ asset('images/'.$pegawai->foto) }}" width="150">
	  	</div>
	  </div>
	  ...
	  <div class="form-group row">
	  	...
	  	<div class="col-sm-4">
			  ...
			  <input type="radio" id="jkl" name="jk" class="custom-control-input" value="L" {{ $l }}>
			  <label class="custom-control-label" for="jkl">Laki-laki</label>
			</div>
			<div class="custom-control custom-radio custom-control-inline">
			  <input type="radio" id="jkp" name="jk" class="custom-control-input" value="P" {{ $p }}>
	  ...
	  <div class="form-group row">
	  	...
	  	<div class="col-sm-3">
	  		<input type="date" class="form-control" name="tanggal" id="tanggal" value="{{ $pegawai->tgl_lahir }}">
	  	</div>
	  </div>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <textarea name="keterangan" class="form-control" id="keterangan">{{ $pegawai->keterangan }}</textarea>
	    </div>
	  </div>
